...
It is, however, possible to reuse the plugin's settings from prooperties on `AzureStorageAttachmentConfiguration` in order to implement your own cleanup solution.
