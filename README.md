...
-->
_**2023-12-14**_: The latest ASB SDK doesn't support plugins and requires inheritance. See details in [#201](https://github.com/SeanFeldman/ServiceBus.AttachmentPlugin/issues/201).
